...
$valor1=10;
$valor2=5;
echo "Como el primer valor es mayor que el segundo ('\$valor1' > '\$valor2'), es decir (10 > 5), el programa nos indica:";
echo "<br>";
if ($valor1 > $valor2) {
    echo $valor1 . " es mayor que " . $valor2;
}
echo "<br>";
echo "Como el segundo valor es menor que el segundo ('\$valor2' < '\$valor1'), es decir (5 < 10), el programa nos indica:";
echo "<br>";
